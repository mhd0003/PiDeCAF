...
namespace au_uav_ros {
	...
	public:
	    ...
	    PlaneObject(int _id, struct au_uav_ros::waypoint wp);
	    ...
	    PlaneObject(int _id);
            ...
            bool update(const au_uav_ros::Telemetry &msg, au_uav_ros::Command &newCommand);
	    ...
	    void addWp(struct au_uav_ros::waypoint wp, bool normal);
	    void removeWp(struct au_uav_ros::waypoint wp, bool normal);
	    ...
	    int commandIndex;
            ...
            /*TODO remove this *///au_uav_ros::waypoint destination;
